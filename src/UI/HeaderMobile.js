...
const HeaderModule = () => {
   ...
   const MenuIcon = (props) => {
        return (
            <button id={props.id} onClick={props.toggleFunction} className={props.menuClass}>
                <svg   width="25" fill="rgb(151,126,79)" height="25" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" dataReactroot="">
